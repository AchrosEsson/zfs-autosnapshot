...
/usr/bin/zfs-prune-snapshots -i -p 'incremental_snapshot_' 1M "$SOURCE_POOL" > zfs-destroyed-snapshots.log

# Lösche alle inkrementellen Snapshots im Zielpool älter als 1 Jahr
/usr/bin/zfs-prune-snapshots -i -p 'incremental_snapshot_' 1y "$DEST_POOL" >> zfs-destroyed-snapshots.log
